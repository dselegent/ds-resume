...
const TemplateCard: React.FC = () => {
  ...
  // 图片预览
  const [isPreview, { setTrue: setisPreviewTrue, setFalse: setisPreviewFalse }] = useBoolean(false)
  ...
  return (
    <>
      <section
        ...
        onBlur={() => void 0}
      >
        <aside className='relative z-0 h-100'>
          <Image
            width='100%'
            height='100%'
            preview={false}
            ...
            src='https://smallpig.site:9000/resume/templatePreview/屏幕截图 2022-10-08 150756-1665212969268.png'
            alt='template'
            loading='lazy'
          />
          {/* 遮罩层 */}
