  ...
  return (
    <section className='min-h-[80vh] w-full bg-white' ref={CustomTemplateRef}>
      ...
      <aside className='box-border min-h-[60vh] f-b-c pb-10 pl-[5%] pr-[2%]'>
        ...
        <div className='ml-25 flex flex-1 flex-col justify-center'>
          <h1 className='translate-y-2.5 break-normal text-justify text-[2vw] lh-normal text-pink-500 letter-1'>
