...
const ProjectIntroduce: React.FC = () => {
  return (
    <section className='h-screen w-full f-b-c from-pink-400 to-blue-400 bg-gradient-to-r'>
      <aside className='pl-25 text-white'>
        ...
        <div className='mt-10 flex'>
          <div className='mr-5 h-10 w-30 cursor-pointer rounded-12 from-green-400 to-cyan-400 bg-gradient-to-r text-center text-sm leading-10 transition-opacity letter-2 hover:opacity-80'>
            免费制作
          </div>
          <div className='mr-5 h-10 w-30 cursor-pointer rounded-12 from-green-400 to-cyan-400 bg-gradient-to-r text-center text-sm leading-10 transition-opacity letter-2 hover:opacity-80'>
            自定义模板
