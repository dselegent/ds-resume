    ...
    <section className='h-15 w-full flex bg-white shadow'>
        ...
        <div className='h-full flex'>
          <div className='flex text-stone-600'>
            <Tooltip title='新增任意简历模块' placement='bottom'>
              <div className='transition-base flex-col-center cursor-pointer px-4 hover:bg-green-50 hover:text-font_color'>
      ...
      <aside className='flex items-center justify-end pr-12.5'>
        <Tooltip title='下载到本地' placement='bottom'>
          <div className='transition-base h-full flex-col-center cursor-pointer bg-lime-600 px-4 text-white hover:bg-lime-500'>
        ...
        <Tooltip title='预览简历' placement='bottom'>
          <div className='transition-base h-full flex-col-center cursor-pointer px-4 hover:bg-green-50 hover:text-font_color'>
